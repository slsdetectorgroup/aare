...
auto jungfrau_ilgad_singlechip_25um_strixel_map =
    [](InclusiveROI rx_roi, int chip_id = 1, defs::BondShift bs = {0, 0}) {
        if (chip_id == 1)
            return algo::strixel_to_pixel_map(
                ...
                config::jungfrau::Chip1, rx_roi, bs);
        else if (chip_id == 6)
            return algo::strixel_to_pixel_map(
                config::jungfrau::SingleChipMP_iLGAD_P25,
...
auto jungfrau_ilgad_singlechip_15um_strixel_map =
    [](InclusiveROI rx_roi, int chip_id = 1, defs::BondShift bs = {0, 0}) {
        if (chip_id == 1)
            return algo::strixel_to_pixel_map(
...
auto jungfrau_ilgad_singlechip_18um_strixel_map =
    [](InclusiveROI rx_roi, int chip_id = 1, defs::BondShift bs = {0, 0}) {
        if (chip_id == 1)
            return algo::strixel_to_pixel_map(
...
auto jungfrau_ilgad_singlechip_multipitch_strixel_maps =
    [](InclusiveROI rx_roi, int chip_id = 1, defs::BondShift bs = {0, 0}) {
