...
// //Update the geometry with a new ROI
// //Do we need a new abstraction for this?
// std::vector<aare::ModuleGeometry> geometry_from_roi(std::vector<aare::ModuleGeometry> m_module_pixel_0, aare::ROI roi) {
